...
public abstract class DeviceImpl extends MinimalEObjectImpl.Container implements Device {
	...
	public NotificationChain basicSetRoom(Room newRoom, NotificationChain msgs) {
		...
		room = newRoom;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HalPackage.DEVICE__ROOM, oldRoom, newRoom);
	...
	public void setRoom(Room newRoom) {
		if (newRoom != room) {
			...
			if (room != null)
				msgs = ((InternalEObject)room).eInverseRemove(this, HalPackage.ROOM__DEVICE, Room.class, msgs);
			if (newRoom != null)
				msgs = ((InternalEObject)newRoom).eInverseAdd(this, HalPackage.ROOM__DEVICE, Room.class, msgs);
